...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="group fixed right-4 z-40 inline-flex h-12 w-12 items-center justify-center rounded-full bg-navy text-turquoise shadow-soft hover:bg-dark-navy max-lg:bottom-[calc(var(--hvb-action-bar-height)+env(safe-area-inset-bottom)+0.75rem)] sm:h-14 sm:w-14 lg:right-6 lg:bottom-6"
